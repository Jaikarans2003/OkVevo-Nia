...
class TestEmbeddedDaemonOverlayFlag:
    def test_serve_process_disables_overlay_when_policy_requires_it(self):
        ...
        with patch.object(
            ...
            # Nia fork delta: pin platform to linux — the asserted command shape is the
            # non-darwin one; upstream only exercises this test on linux CI, and on a
            # macOS dev machine the darwin branch requires a real CuaDriver.app.
