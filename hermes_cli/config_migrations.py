...
def _migrate_to_40(results: Dict[str, Any], quiet: bool) -> None:
    # ── Nia fork delta — Version 39 → 40: pin compression + vision to OpenRouter GLM ──
    ...
    # Shares target-version 40 with upstream's model_catalog ttl step —
    # disjoint keys, both run for ≤39 configs.
...
MIGRATIONS: Tuple[Tuple[int, Callable[[Dict[str, Any], bool], None]], ...] = (
    ...
    # Nia fork delta: GLM aux pin shares v40 (disjoint keys from the ttl step).
    (40, _migrate_to_40),
    (41, _migrate_to_41),
