...
def _finish_profile_layout(profile_dir: Path, *, no_skills: bool, clone_all: bool,
    ...
    # Seed a SOUL.md to customize immediately (skipped when a clone already
    # provided one). Nia fork delta: a named profile is a Nia bot, so it must
    # NOT get Nia's own persona (DEFAULT_SOUL_MD says "You are Nia") — a
    # blank-personality bot would introduce itself as Nia. Seed the bot's name.
...
# ---- Nia fork delta: named-profile (bot) provisioning shared by RPC + manage_bot ----
