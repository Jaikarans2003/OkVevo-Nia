...
from hermes_cli.tools_config_cua import (  # noqa: F401
    ...
    PINNED_CUA_DRIVER_VERSION, _parse_cua_driver_semver)
...
# Nia: video_gen is ON by default (product decision, 2026-09) — ``video_generate`` sits in
# _HERMES_CORE_TOOLS alongside image_generate; provider/model pick stays in `hermes tools`.
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "video", "x_search", "a2a", "kanban"}
