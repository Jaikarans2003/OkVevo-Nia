...
def _post_setup_agent_browser(post_setup_key: str) -> None:
    ...
    try:
        ...
        # Nia fork delta: upstream moved these helpers to tools/browser_tool_install
        # (browser-tool split we do not carry); tools/browser_tool_install.py is a
        # Nia shim re-exporting them from tools/browser_tool.
