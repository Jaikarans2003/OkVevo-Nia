...
$RepoUrlSsh = "git@github.com:Jaikarans2003/OkVevo-Nia.git"
$RepoUrlHttps = "https://github.com/Jaikarans2003/OkVevo-Nia.git"
$PythonVersion = "3.11"
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/Jaikarans2003/OkVevo-Nia/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/Jaikarans2003/OkVevo-Nia/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/Jaikarans2003/OkVevo-Nia/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
