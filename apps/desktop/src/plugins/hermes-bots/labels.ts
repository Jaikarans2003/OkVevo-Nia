...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Nia". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Nia" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Nia (the agent it is)
