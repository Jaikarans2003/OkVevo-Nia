...
export const zh: Translations = {
  ...
  settings: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'Nia 运行时已更新，但桌面应用本身仍是旧构建——在应用更新之前，新的界面功能不会显示。请运行下方的更新。如果此警告仍未消除，请从 okvevo.com 安装最新桌面应用。',
  ...
  updates: {
    ...
    availableBodyBackend: '已连接的 Nia 后端有新版本可安装。',
    ...
    guiSkewBody:
      '后端已更新，但此桌面应用包未更改。请更新或重新安装 Nia 桌面应用（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody:
