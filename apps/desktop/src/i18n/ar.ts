...
export const ar = defineLocale({
  ...
  updates: {
    ...
    availableBodyBackend: 'إصدار أحدث من واجهة Nia الخلفية المتصلة جاهز للتثبيت.',
    ...
    guiSkewBody:
      'تم تحديث الواجهة الخلفية، لكن حزمة تطبيق سطح المكتب هذه لم تتغير. حدّث أو أعد تثبيت تطبيق Nia لسطح المكتب (ملف AppImage / ‎.deb / ‎.rpm) لمطابقته.',
    copy: 'نسخ',
    copied: 'تم النسخ',
    done: 'تم',
    applyingBody:
