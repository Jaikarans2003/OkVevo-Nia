...
export const en: Translations = {
  ...
  settings: {
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Nia runtime was updated, but the desktop app itself is still an older build — new interface features will be missing until it updates. Install the latest desktop app from okvevo.com if Check for updates doesn\u2019t clear this warning.',
  ...
  composer: {
    ...
    disclaimer: 'Nia is AI Agent and can make mistakes, please double-check responses',
    commandDescs: {
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Nia can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Nia is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Nia backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Nia from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Nia will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Nia desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
    ...
    foreignBlockerTitle: 'Close other processes to update Nia',
    foreignBlockerBody:
      'Nia can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Nia can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Nia needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Nia Desktop',
    setupChoiceDesc:
      'Connect this app to a Nia gateway you already run, or install Nia locally on this computer.',
    connectExistingTitle: 'Connect to existing Nia',
    ...
    installLocalTitle: 'Install Nia locally',
    installNia: 'Install Nia',
    installLocalDesc: 'Download Nia, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Nia Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Nia',
    remoteSetupDesc: 'Enter your gateway URL. Nia Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Nia gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Nia gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Nia Agent',
    settingUpNiaTitle: 'Setting Up Nia',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Nia CLI or desktop instance is running. Stop any running Nia instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Nia Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Nia is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Nia…',
