...
export function ContribWiring({ children }: { children: ReactNode }) {
  ...
  // settings (see titlebar-controls.tsx). A shared width that under-counts
  // leaves the find bar, the titlebar header padding, and the pane-cluster
  // anchor overlapping the last button.
