  ...
  return (
    <TooltipPrimitive.Portal>
      ...
      >
        ...
        <span className="box-decoration-clone inline rounded-[var(--composer-corner-radius)] bg-foreground px-1.5 py-1 text-[11px] font-bold leading-normal text-background [font-family:Arial,sans-serif] [&>*]:!inline-flex">
          {children}
        </span>
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
