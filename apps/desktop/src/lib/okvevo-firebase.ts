...
const firebaseConfig = {
  apiKey: env.VITE_OKVEVO_FIREBASE_API_KEY || '',
  authDomain: env.VITE_OKVEVO_FIREBASE_AUTH_DOMAIN || '',
  projectId: env.VITE_OKVEVO_FIREBASE_PROJECT_ID || '',
  storageBucket: env.VITE_OKVEVO_FIREBASE_STORAGE_BUCKET || '',
  messagingSenderId: env.VITE_OKVEVO_FIREBASE_MESSAGING_SENDER_ID || '',
  appId: env.VITE_OKVEVO_FIREBASE_APP_ID || ''
}
