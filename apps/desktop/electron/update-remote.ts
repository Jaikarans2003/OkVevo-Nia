 ...
 *
 * A public install can end up with `origin=git@github.com:Jaikarans2003/OkVevo-Nia.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Jaikarans2003/OkVevo-Nia.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/jaikarans2003/okvevo-nia'
