...
test('resolveRemovableAppPath finds the .app bundle on macOS', () => {
  assert.equal(
    resolveRemovableAppPath('/Applications/Nia.app/Contents/MacOS/Nia', 'darwin'),
    '/Applications/Nia.app'
  )
  assert.equal(
    resolveRemovableAppPath('/Users/x/Applications/Nia.app/Contents/MacOS/Nia', 'darwin'),
    '/Users/x/Applications/Nia.app'
  )
})
...
test('resolveRemovableAppPath finds the install dir on Windows', () => {
  assert.equal(
    resolveRemovableAppPath('C:\\Users\\x\\AppData\\Local\\Programs\\Nia\\Nia.exe', 'win32'),
    'C:\\Users\\x\\AppData\\Local\\Programs\\Nia'
  )
  assert.equal(
  ...
  assert.equal(
    resolveRemovableAppPath('C:\\Users\\x\\AppData\\Local\\hermes-desktop\\Nia.exe', 'win32'),
    'C:\\Users\\x\\AppData\\Local\\hermes-desktop'
  )
})

test('resolveRemovableAppPath returns null for an unrecognized Windows dir', () => {
  assert.equal(resolveRemovableAppPath('C:\\Temp\\foo\\Nia.exe', 'win32'), null)
})
...
test('shouldRemoveAppBundle requires packaged AND a resolved path', () => {
  assert.equal(shouldRemoveAppBundle(true, '/Applications/Nia.app'), true)
  assert.equal(shouldRemoveAppBundle(false, '/Applications/Nia.app'), false)
