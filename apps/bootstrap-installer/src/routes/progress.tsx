...
export default function ProgressScreen({ bootstrap }: ProgressProps) {
  ...
  const title = bootstrap.status === 'completed' ? 'Done' : isUpdate ? 'Updating Nia' : 'Setting up Nia'

  const description = isUpdate
    ? 'Nia is updating to the latest version — this only takes a moment.'
    : 'This is a one-time setup. The Nia installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.'
