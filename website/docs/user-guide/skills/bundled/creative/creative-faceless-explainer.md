...
sidebar_label: "Faceless Explainer"
description: "Turn arbitrary text — an article, notes, a topic, a brief — into a faceless explainer video: there is no site or footage to capture, so the visuals are inven..."
---
...
| Path | `skills/creative/faceless-explainer` |
...
| Read                                                                                                                                                        | When                                                                                                     |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `[../hyperframes-core/references/brief-contract.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-core/references/brief-contract.md)`                                                      | Gate types, mode derivation from `BRIEF.md`, field semantics.                                            |
| `[../hyperframes-creative/references/story-spine.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-creative/references/story-spine.md)`                                                    | Step 3: story doctrine — hook language, value-before-evidence, proposal shape, source-traceable visuals. |
| `[../hyperframes-creative/frame-presets/](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-creative/frame-presets/)`                                                                          | Step 2: choose and adopt a frame preset.                                                                 |
| `[../hyperframes-creative/references/design-spec.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-creative/references/design-spec.md)`                                                    | Step 2: apply brand tokens correctly.                                                                    |
| `[references/story-design.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/references/story-design.md)`                                                                                                  | Step 3: plan the explainer story.                                                                        |
| `[../hyperframes-animation/blueprints-index.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-animation/blueprints-index.md)`                                                              | Step 3: role→blueprint menu. Step 4: pick the shot shape.                                                |
| `[../hyperframes-core/references/storyboard-format.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-core/references/storyboard-format.md)`                                                | Step 3: write `STORYBOARD.md`.                                                                           |
| `[../hyperframes-core/references/script-format.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-core/references/script-format.md)`                                                        | Step 3: write `SCRIPT.md`.                                                                               |
| `[../media-use/audio/references/tts.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../media-use/audio/references/tts.md)`                                                                              | Step 3.1: choose or understand TTS providers and voices.                                                 |
| `[references/visual-design.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/references/visual-design.md)`                                                                                                | Step 4: write the frame's shot sequence (+ Layout vocabulary).                                           |
| `[references/motion-language.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/references/motion-language.md)`                                                                                            | Step 4: the motion vocabulary + the motion doctrine.                                                     |
| `[references/cut-catalog.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/references/cut-catalog.md)`                                                                                                    | Step 4-5: the cut catalog (worker builds within-frame seams).                                            |
| `[../hyperframes-animation/rules-index.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-animation/rules-index.md)` + `[../hyperframes-animation/rules/](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-animation/rules/)` | Step 5: local rule recipe bodies for the cited motions.                                                  |
| `[../hyperframes-core/references/frame-worker-core.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-core/references/frame-worker-core.md)`                                                | Step 5: the shared worker contract (packet builder prepends it to the delta).                            |
| `[sub-agents/frame-worker.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/sub-agents/frame-worker.md)`                                                                                                  | Step 5: the workflow's frame-worker delta.                                                               |
| `[../hyperframes-core/references/subagent-dispatch.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/faceless-explainer/../hyperframes-core/references/subagent-dispatch.md)`                                                | Step 5: dispatch sub-agents safely.                                                                      |
