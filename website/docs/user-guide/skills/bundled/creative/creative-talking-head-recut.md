...
sidebar_label: "Talking Head Recut"
description: "Package an existing talking-head / interview / podcast video with timed, designed GRAPHIC OVERLAY cards — kinetic titles, lower-thirds, data callouts, quotes..."
---
...
| Path | `skills/creative/talking-head-recut` |
...
See
[`references/frames/`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/talking-head-recut/references/frames/) for each frame's placement
