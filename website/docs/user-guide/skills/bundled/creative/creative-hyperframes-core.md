---
title: "Hyperframes Core — The HyperFrames composition contract — build one renderable project"
sidebar_label: "Hyperframes Core"
...
| Path | `skills/creative/hyperframes-core` |
