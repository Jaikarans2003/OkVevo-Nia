...
sidebar_label: "Music To Video"
description: "Turn a music track (an audio file, a video to pull audio from, or a track generated from a mood brief) into a beat-synced video — lyric video, slideshow, or ..."
---
...
| Path | `skills/creative/music-to-video` |
...
Read [`references/planning.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/planning.md), [`storyboard-format.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/storyboard-format.md), [`template-catalog.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/template-catalog.md), [`motion-primitive-catalog.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/motion-primitive-catalog.md), and [`montage.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/montage.md) (only if the user supplied assets). Editing the same file in place, do two things:
...
Create `compositions/frames/`. Read [`sub-agents/frame-worker.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/sub-agents/frame-worker.md) and `../hyperframes-core/references/subagent-dispatch.md`. Dispatch **one frame-worker per frame**, in parallel where possible (otherwise in waves). Each worker gets exactly one frame and this context:
...
| Read                                                                                                           | When                                                    |
| -------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| [`references/frame-skeleton.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/frame-skeleton.md)                                                 | Step 2: read the music, lay out the frames, set pacing  |
| [`references/planning.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/planning.md) · [`storyboard-format.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/storyboard-format.md) | Step 3: pick the brand, fill each frame, write the plan |
| [`references/template-catalog.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/template-catalog.md)                                             | Step 3: pick a template per group                       |
| [`references/motion-primitive-catalog.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/motion-primitive-catalog.md)                             | Step 3/4: L0 recipes for free-compose                   |
| [`references/montage.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/references/montage.md)                                                               | Step 3/4: asset treatments (beat-cut / ken-burns)       |
| [`sub-agents/frame-worker.md`](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/music-to-video/sub-agents/frame-worker.md)                                                     | Step 4: dispatch + build one frame                      |
