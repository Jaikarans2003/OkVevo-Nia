---
title: "Pr To Video"
sidebar_label: "Pr To Video"
description: "Turn a GitHub pull request (a PR URL, owner/repo#N, or 'this PR' in a checked-out repo) into a code-change explainer video — changelog, feature reveal, fix, ..."
---
...
| Path | `skills/creative/pr-to-video` |
...
| Read                                                                                                                                                        | When                                                                                                     |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| `[../hyperframes-core/references/brief-contract.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-core/references/brief-contract.md)`                                                      | Gate types, mode derivation from `BRIEF.md`, field semantics.                                            |
| `[../hyperframes-creative/references/story-spine.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-creative/references/story-spine.md)`                                                    | Step 3: story doctrine — hook language, value-before-evidence, proposal shape, source-traceable visuals. |
| `[references/story-design.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/references/story-design.md)`                                                                                                  | Step 3: plan the PR explanation.                                                                         |
| `[../hyperframes-animation/blueprints-index.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-animation/blueprints-index.md)`                                                              | Step 3: role→blueprint menu. Step 4: pick the shot shape.                                                |
| `[../hyperframes-core/references/storyboard-format.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-core/references/storyboard-format.md)`                                                | Step 3: write `STORYBOARD.md`.                                                                           |
| `[../hyperframes-core/references/script-format.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-core/references/script-format.md)`                                                        | Step 3: write `SCRIPT.md`.                                                                               |
| `[../media-use/audio/references/tts.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../media-use/audio/references/tts.md)`                                                                              | Step 3.1: choose or understand TTS providers.                                                            |
| `[references/visual-design.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/references/visual-design.md)`                                                                                                | Step 4: write the frame's shot sequence (+ Layout vocabulary).                                           |
| `[references/code-vocabulary.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/references/code-vocabulary.md)`                                                                                            | Step 4 + 5: pick + fill the `code-*` block for a code beat.                                              |
| `[references/motion-language.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/references/motion-language.md)`                                                                                            | Step 4: the motion vocabulary + the motion doctrine.                                                     |
| `[references/cut-catalog.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/references/cut-catalog.md)`                                                                                                    | Step 4-5: the cut catalog (worker builds within-frame seams).                                            |
| `[../hyperframes-animation/rules-index.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-animation/rules-index.md)` + `[../hyperframes-animation/rules/](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-animation/rules/)` | Step 5: local rule recipe bodies for the cited motions.                                                  |
| `[../hyperframes-core/references/frame-worker-core.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-core/references/frame-worker-core.md)`                                                | Step 5: the shared worker contract (packet builder prepends it to the delta).                            |
| `[sub-agents/frame-worker.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/sub-agents/frame-worker.md)`                                                                                                  | Step 5: the workflow's frame-worker delta.                                                               |
| `[../hyperframes-core/references/subagent-dispatch.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-core/references/subagent-dispatch.md)`                                                | Step 5: dispatch sub-agents safely.                                                                      |
| `[../hyperframes-creative/frame-presets/code-editorial/FRAME.md](https://github.com/NousResearch/hermes-agent/blob/main/skills/creative/pr-to-video/../hyperframes-creative/frame-presets/code-editorial/FRAME.md)`                            | Step 2: the code-editorial preset (fixed style).                                                         |
