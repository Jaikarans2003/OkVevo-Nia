...
description: "Mandatory entry point: read this first for any request to make, create, edit, animate, or render a video, animation, or motion graphic, including a promo, ex..."
---
...
| Path | `skills/creative/hyperframes` |
