...
sidebar_label: "Hyperframes Audio"
description: "Use when audio already placed in a HyperFrames composition needs to be mixed: fade-in/fade-out, crossfade, track gain or volume, volume automation, ducking, ..."
---
...
| Path | `skills/creative/hyperframes-audio` |
