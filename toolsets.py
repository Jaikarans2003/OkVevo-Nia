...
_HERMES_CORE_TOOLS = [
    ...
    # Nia: vision + image/video generation (video ON by default — product decision 2026-09)
    ...
    "session_search",
    "clarify",
    # Nia: bot create/list/update (least-privilege stand-in for editing internals)
    "manage_bot",
...
TOOLSETS = {
    ...
    "video_gen": _ts(
        ...
        # Nia: static membership is the subset-inference view (issue #49622): with
    ...
    # Nia: bot management surface (OkVevo product toolset)
    "bots": _ts("Create, list, and update Nia bots", ["manage_bot"]),
    "computer_use": _ts(
